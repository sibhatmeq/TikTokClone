...
import 'package:sibhat_tiktok/models/video.dart';
...
class UploadVideoController extends GetxController{
  ...
  _compressVideo(String videoPath)async{
   ...
   Future<String> _uploadVideoToStorage(String id, String videoPath)async{
    Reference ref = firebaseStorage.ref().child("vidoes").child(id);
  ...
  _getThumbnail(String vidoePath)async{
   final thumbnail = await VideoCompress.getFileThumbnail(vidoePath);
   return thumbnail;
  }
  ...
  uploadVideo(String songName, String caption, String videoPath)async{
    ...
    String videoUrl = await  _uploadVideoToStorage("Vidoe $len", videoPath);
